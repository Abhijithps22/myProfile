...
const Home = () => {
    return (
        <section id="home" className="min-h-screen flex items-center justify-center pt-32 pb-20 relative overflow-hidden bg-background">
            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    <motion.div
                        ...
                        className="inline-block px-3 py-1 bg-secondary/10 text-secondary-foreground rounded-full text-sm font-medium mb-2 ring-1 ring-primary/20"
                    >
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed max-w-lg mx-auto md:mx-0 pt-4">
                ...
                <motion.div
                    ...
                    className="relative mx-auto w-64 h-64 md:w-96 md:h-96 flex items-center justify-center p-4 lg:scale-100 md:scale-90 scale-75"
                >
